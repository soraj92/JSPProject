...
<div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              ...
              <%--style="height: 21.875rem" width="25rem" --%>
                <a href="content.do?board_num=<%=i.getBoard_num()%>" style="height:20rem">
                <img class="card-img-top" src="imgupload/<%=i.getImg() %>" alt="" style="max-height:20rem"></a>
                <div class="card-body">
                  <h4 class="card-title">
                  <%-- 글제목 --%>
				...
				<div id ="paging">
					...
					<%
								if(current_page<=1){
									...
									out.print("<a href='index.com?page="+(current_page-1)+"' class = 'prev'>");
									out.print("이전 </a>");
								}
						...
						for(int i =start_page; i<=end_page; i++)
						{
							...
							{
								out.print("<a href=index.com?page="+i+" class ='num'>");
								out.print(i+"</a>");
							}
						}
